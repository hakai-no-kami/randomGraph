#include "ros/ros.h"
  ...
  std::mt19937 gen(rd());
  std::normal_distribution<> d(0.011118, 0.005);
...
void chatterCallback17(const std_msgs::String::ConstPtr& msg){
  	usleep(d(gen)*1000000);
  	ROS_INFO("I'm node19 and heard from node17: [%s]", msg->data.c_str());
  }
...
int main(int argc, char **argv){
	...
	ros::Subscriber sub_17_19 = n.subscribe("topic_17_19", 1, chatterCallback17);
