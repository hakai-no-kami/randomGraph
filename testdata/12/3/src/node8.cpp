  ...
  std::mt19937 gen(rd());
  std::normal_distribution<> d(0.026433, 0.005);
  class Node8{
  	public:
  		Node8(){
			sub_2_8_flag = 0;
		...
		void middlemanCallback2(const std_msgs::String::ConstPtr& msg){
  			if(sub_3_8_flag == 1 && sub_4_8_flag == 1 && sub_6_8_flag == 1 && sub_7_8_flag == 1 &&  true){
		...
		void middlemanCallback4(const std_msgs::String::ConstPtr& msg){
  			if(sub_2_8_flag == 1 && sub_3_8_flag == 1 && sub_6_8_flag == 1 && sub_7_8_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback6(const std_msgs::String::ConstPtr& msg){
  			if(sub_2_8_flag == 1 && sub_3_8_flag == 1 && sub_4_8_flag == 1 && sub_7_8_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback7(const std_msgs::String::ConstPtr& msg){
  			if(sub_2_8_flag == 1 && sub_3_8_flag == 1 && sub_4_8_flag == 1 && sub_6_8_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
