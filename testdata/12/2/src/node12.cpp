#include "ros/ros.h"
  ...
  std::mt19937 gen(rd());
  std::normal_distribution<> d(0.018750, 0.005);
void chatterCallback5(const std_msgs::String::ConstPtr& msg){
  	usleep(d(gen)*1000000);
  	ROS_INFO("I'm node12 and heard from node5: [%s]", msg->data.c_str());
  }
...
int main(int argc, char **argv){
  	...
  	ros::NodeHandle n;
	ros::Subscriber sub_5_12 = n.subscribe("topic_5_12", 1, chatterCallback5);
