  ...
  std::mt19937 gen(rd());
  std::normal_distribution<> d(0.018269, 0.005);
  class Node16{
  	public:
  		Node16(){
			sub_7_16_flag = 0;
		...
		void middlemanCallback14(const std_msgs::String::ConstPtr& msg){
  			if(sub_7_16_flag == 1 && sub_13_16_flag == 1 && sub_15_16_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback15(const std_msgs::String::ConstPtr& msg){
  			if(sub_7_16_flag == 1 && sub_13_16_flag == 1 && sub_14_16_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
