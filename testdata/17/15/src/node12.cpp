  ...
  std::mt19937 gen(rd());
  std::normal_distribution<> d(0.025417, 0.005);
  class Node12{
  	public:
  		Node12(){
			sub_1_12_flag = 0;
		...
		void middlemanCallback1(const std_msgs::String::ConstPtr& msg){
  			if(sub_6_12_flag == 1 && sub_8_12_flag == 1 && sub_9_12_flag == 1 && sub_10_12_flag == 1 && sub_11_12_flag == 1 &&  true){
		...
		void middlemanCallback6(const std_msgs::String::ConstPtr& msg){
  			if(sub_1_12_flag == 1 && sub_8_12_flag == 1 && sub_9_12_flag == 1 && sub_10_12_flag == 1 && sub_11_12_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback8(const std_msgs::String::ConstPtr& msg){
  			if(sub_1_12_flag == 1 && sub_6_12_flag == 1 && sub_9_12_flag == 1 && sub_10_12_flag == 1 && sub_11_12_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback9(const std_msgs::String::ConstPtr& msg){
  			if(sub_1_12_flag == 1 && sub_6_12_flag == 1 && sub_8_12_flag == 1 && sub_10_12_flag == 1 && sub_11_12_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback10(const std_msgs::String::ConstPtr& msg){
  			if(sub_1_12_flag == 1 && sub_6_12_flag == 1 && sub_8_12_flag == 1 && sub_9_12_flag == 1 && sub_11_12_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback11(const std_msgs::String::ConstPtr& msg){
  			if(sub_1_12_flag == 1 && sub_6_12_flag == 1 && sub_8_12_flag == 1 && sub_9_12_flag == 1 && sub_10_12_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
