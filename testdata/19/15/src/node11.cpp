  ...
  std::mt19937 gen(rd());
  std::normal_distribution<> d(0.029768, 0.005);
  class Node11{
  	public:
  		Node11(){
			sub_4_11_flag = 0;
		...
		void middlemanCallback7(const std_msgs::String::ConstPtr& msg){
  			if(sub_4_11_flag == 1 && sub_10_11_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback10(const std_msgs::String::ConstPtr& msg){
  			if(sub_4_11_flag == 1 && sub_7_11_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
