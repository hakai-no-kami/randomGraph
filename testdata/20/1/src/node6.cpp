  ...
  std::mt19937 gen(rd());
  std::normal_distribution<> d(0.016521, 0.005);
  class Node6{
  	public:
  		Node6(){
			sub_2_6_flag = 0;
			...
			pub_6_16 = n.advertise<std_msgs::String>("topic_6_16", 1);
		}
		void middlemanCallback2(const std_msgs::String::ConstPtr& msg){
  			if(sub_3_6_flag == 1 && sub_5_6_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
  				ROS_INFO("I'm node6 last from node2, intercepted: [%s]", msg->data.c_str());
				pub_6_16.publish(msg);
				sub_3_6_flag = 0;
				sub_5_6_flag = 0;
			}
  			else{
