  ...
  std::mt19937 gen(rd());
  std::normal_distribution<> d(0.028924, 0.005);
  class Node17{
  	public:
  		Node17(){
			sub_13_17_flag = 0;
		...
		void middlemanCallback13(const std_msgs::String::ConstPtr& msg){
  			if(sub_14_17_flag == 1 && sub_15_17_flag == 1 && sub_16_17_flag == 1 &&  true){
		...
		void middlemanCallback14(const std_msgs::String::ConstPtr& msg){
  			if(sub_13_17_flag == 1 && sub_15_17_flag == 1 && sub_16_17_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
