  ...
  std::mt19937 gen(rd());
  std::normal_distribution<> d(0.013371, 0.005);
  class Node12{
  	public:
  		Node12(){
			sub_2_12_flag = 0;
		...
		void middlemanCallback2(const std_msgs::String::ConstPtr& msg){
  			if(sub_3_12_flag == 1 && sub_8_12_flag == 1 && sub_10_12_flag == 1 &&  true){
		...
		void middlemanCallback3(const std_msgs::String::ConstPtr& msg){
  			if(sub_2_12_flag == 1 && sub_8_12_flag == 1 && sub_10_12_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback10(const std_msgs::String::ConstPtr& msg){
  			if(sub_2_12_flag == 1 && sub_3_12_flag == 1 && sub_8_12_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
