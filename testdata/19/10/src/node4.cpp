  ...
  std::mt19937 gen(rd());
  std::normal_distribution<> d(0.021547, 0.005);
  class Node4{
  	public:
  		Node4(){
			sub_1_4_flag = 0;
			...
			pub_4_14 = n.advertise<std_msgs::String>("topic_4_14", 1);
		...
		void middlemanCallback2(const std_msgs::String::ConstPtr& msg){
  			if(sub_1_4_flag == 1 && sub_3_4_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback3(const std_msgs::String::ConstPtr& msg){
  			if(sub_1_4_flag == 1 && sub_2_4_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
