  ...
  std::mt19937 gen(rd());
  std::normal_distribution<> d(0.021296, 0.005);
  class Node1{
  	public:
  		Node1(){
			sub_0_1_flag = 0;
  			sub_0_1 = n.subscribe("topic_0_1", 1, &Node1::middlemanCallback0,this);
			pub_1_15 = n.advertise<std_msgs::String>("topic_1_15", 1);
			pub_1_12 = n.advertise<std_msgs::String>("topic_1_12", 1);
		...
		void middlemanCallback0(const std_msgs::String::ConstPtr& msg){
  			if( true){
				...
				pub_1_15.publish(msg);
				pub_1_12.publish(msg);
				pub_1_5.publish(msg);
			}
  			else{
	...
	private:
  		ros::NodeHandle n; 
		ros::Publisher pub_1_15;
		ros::Publisher pub_1_12;
