#include "ros/ros.h"
  ...
  std::mt19937 gen(rd());
  std::normal_distribution<> d(0.024336, 0.005);
void chatterCallback10(const std_msgs::String::ConstPtr& msg){
  	usleep(d(gen)*1000000);
  	ROS_INFO("I'm node15 and heard from node10: [%s]", msg->data.c_str());
  }
...
int main(int argc, char **argv){
  	...
  	ros::NodeHandle n;
	ros::Subscriber sub_10_15 = n.subscribe("topic_10_15", 1, chatterCallback10);
