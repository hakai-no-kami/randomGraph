  ...
  std::mt19937 gen(rd());
  std::normal_distribution<> d(0.013663, 0.005);
  class Node16{
  	public:
  		Node16(){
			sub_6_16_flag = 0;
		...
		void middlemanCallback13(const std_msgs::String::ConstPtr& msg){
  			if(sub_6_16_flag == 1 && sub_14_16_flag == 1 && sub_15_16_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback14(const std_msgs::String::ConstPtr& msg){
  			if(sub_6_16_flag == 1 && sub_13_16_flag == 1 && sub_15_16_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
