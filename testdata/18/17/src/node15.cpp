  ...
  std::mt19937 gen(rd());
  std::normal_distribution<> d(0.013079, 0.005);
  class Node15{
  	public:
  		Node15(){
			sub_6_15_flag = 0;
		...
		void middlemanCallback8(const std_msgs::String::ConstPtr& msg){
  			if(sub_6_15_flag == 1 && sub_11_15_flag == 1 && sub_13_15_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback11(const std_msgs::String::ConstPtr& msg){
  			if(sub_6_15_flag == 1 && sub_8_15_flag == 1 && sub_13_15_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
