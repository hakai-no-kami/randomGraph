  ...
  std::mt19937 gen(rd());
  std::normal_distribution<> d(0.024683, 0.005);
  class Node12{
  	public:
  		Node12(){
			sub_3_12_flag = 0;
		...
		void middlemanCallback3(const std_msgs::String::ConstPtr& msg){
  			if(sub_7_12_flag == 1 && sub_8_12_flag == 1 && sub_9_12_flag == 1 && sub_10_12_flag == 1 &&  true){
		...
		void middlemanCallback7(const std_msgs::String::ConstPtr& msg){
  			if(sub_3_12_flag == 1 && sub_8_12_flag == 1 && sub_9_12_flag == 1 && sub_10_12_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback8(const std_msgs::String::ConstPtr& msg){
  			if(sub_3_12_flag == 1 && sub_7_12_flag == 1 && sub_9_12_flag == 1 && sub_10_12_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback9(const std_msgs::String::ConstPtr& msg){
  			if(sub_3_12_flag == 1 && sub_7_12_flag == 1 && sub_8_12_flag == 1 && sub_10_12_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback10(const std_msgs::String::ConstPtr& msg){
  			if(sub_3_12_flag == 1 && sub_7_12_flag == 1 && sub_8_12_flag == 1 && sub_9_12_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
