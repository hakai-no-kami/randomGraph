  ...
  std::mt19937 gen(rd());
  std::normal_distribution<> d(0.014832, 0.005);
  class Node18{
  	public:
  		Node18(){
			sub_13_18_flag = 0;
		...
		void middlemanCallback13(const std_msgs::String::ConstPtr& msg){
  			if(sub_16_18_flag == 1 && sub_17_18_flag == 1 &&  true){
		...
		void middlemanCallback16(const std_msgs::String::ConstPtr& msg){
  			if(sub_13_18_flag == 1 && sub_17_18_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback17(const std_msgs::String::ConstPtr& msg){
  			if(sub_13_18_flag == 1 && sub_16_18_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
