  ...
  std::mt19937 gen(rd());
  std::normal_distribution<> d(0.024125, 0.005);
  class Node7{
  	public:
  		Node7(){
			sub_1_7_flag = 0;
		...
		void middlemanCallback1(const std_msgs::String::ConstPtr& msg){
  			if(sub_2_7_flag == 1 && sub_5_7_flag == 1 && sub_6_7_flag == 1 &&  true){
		...
		void middlemanCallback2(const std_msgs::String::ConstPtr& msg){
  			if(sub_1_7_flag == 1 && sub_5_7_flag == 1 && sub_6_7_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback5(const std_msgs::String::ConstPtr& msg){
  			if(sub_1_7_flag == 1 && sub_2_7_flag == 1 && sub_6_7_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback6(const std_msgs::String::ConstPtr& msg){
  			if(sub_1_7_flag == 1 && sub_2_7_flag == 1 && sub_5_7_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
