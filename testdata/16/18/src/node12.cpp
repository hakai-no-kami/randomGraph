  ...
  std::mt19937 gen(rd());
  std::normal_distribution<> d(0.017124, 0.005);
  class Node12{
  	public:
  		Node12(){
			sub_4_12_flag = 0;
		...
		void middlemanCallback4(const std_msgs::String::ConstPtr& msg){
  			if(sub_5_12_flag == 1 && sub_9_12_flag == 1 && sub_10_12_flag == 1 && sub_11_12_flag == 1 &&  true){
		...
		void middlemanCallback5(const std_msgs::String::ConstPtr& msg){
  			if(sub_4_12_flag == 1 && sub_9_12_flag == 1 && sub_10_12_flag == 1 && sub_11_12_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback9(const std_msgs::String::ConstPtr& msg){
  			if(sub_4_12_flag == 1 && sub_5_12_flag == 1 && sub_10_12_flag == 1 && sub_11_12_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback10(const std_msgs::String::ConstPtr& msg){
  			if(sub_4_12_flag == 1 && sub_5_12_flag == 1 && sub_9_12_flag == 1 && sub_11_12_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback11(const std_msgs::String::ConstPtr& msg){
  			if(sub_4_12_flag == 1 && sub_5_12_flag == 1 && sub_9_12_flag == 1 && sub_10_12_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
