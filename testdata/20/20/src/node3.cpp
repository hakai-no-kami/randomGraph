  ...
  std::mt19937 gen(rd());
  std::normal_distribution<> d(0.013477, 0.005);
  class Node3{
  	public:
  		Node3(){
			sub_2_3_flag = 0;
  			sub_2_3 = n.subscribe("topic_2_3", 1, &Node3::middlemanCallback2,this);
			pub_3_16 = n.advertise<std_msgs::String>("topic_3_16", 1);
			pub_3_15 = n.advertise<std_msgs::String>("topic_3_15", 1);
		...
		void middlemanCallback2(const std_msgs::String::ConstPtr& msg){
  			if( true){
				...
				pub_3_16.publish(msg);
				pub_3_15.publish(msg);
				pub_3_4.publish(msg);
			}
  			else{
	...
	private:
  		ros::NodeHandle n; 
		ros::Publisher pub_3_16;
		ros::Publisher pub_3_15;
