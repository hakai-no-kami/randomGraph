  ...
  std::mt19937 gen(rd());
  std::normal_distribution<> d(0.025656, 0.005);
  class Node10{
  	public:
  		Node10(){
			sub_3_10_flag = 0;
		...
		void middlemanCallback4(const std_msgs::String::ConstPtr& msg){
  			if(sub_3_10_flag == 1 && sub_6_10_flag == 1 && sub_8_10_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback6(const std_msgs::String::ConstPtr& msg){
  			if(sub_3_10_flag == 1 && sub_4_10_flag == 1 && sub_8_10_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback8(const std_msgs::String::ConstPtr& msg){
  			if(sub_3_10_flag == 1 && sub_4_10_flag == 1 && sub_6_10_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
