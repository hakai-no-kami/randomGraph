  ...
  std::mt19937 gen(rd());
  std::normal_distribution<> d(0.010122, 0.005);
  class Node14{
  	public:
  		Node14(){
			sub_7_14_flag = 0;
		...
		void middlemanCallback7(const std_msgs::String::ConstPtr& msg){
  			if(sub_10_14_flag == 1 && sub_11_14_flag == 1 && sub_12_14_flag == 1 && sub_13_14_flag == 1 &&  true){
		...
		void middlemanCallback10(const std_msgs::String::ConstPtr& msg){
  			if(sub_7_14_flag == 1 && sub_11_14_flag == 1 && sub_12_14_flag == 1 && sub_13_14_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback11(const std_msgs::String::ConstPtr& msg){
  			if(sub_7_14_flag == 1 && sub_10_14_flag == 1 && sub_12_14_flag == 1 && sub_13_14_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback13(const std_msgs::String::ConstPtr& msg){
  			if(sub_7_14_flag == 1 && sub_10_14_flag == 1 && sub_11_14_flag == 1 && sub_12_14_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
