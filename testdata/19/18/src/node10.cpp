  ...
  std::mt19937 gen(rd());
  std::normal_distribution<> d(0.015391, 0.005);
  class Node10{
  	public:
  		Node10(){
			sub_2_10_flag = 0;
		...
		void middlemanCallback2(const std_msgs::String::ConstPtr& msg){
  			if(sub_3_10_flag == 1 && sub_5_10_flag == 1 && sub_7_10_flag == 1 &&  true){
		...
		void middlemanCallback7(const std_msgs::String::ConstPtr& msg){
  			if(sub_2_10_flag == 1 && sub_3_10_flag == 1 && sub_5_10_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
