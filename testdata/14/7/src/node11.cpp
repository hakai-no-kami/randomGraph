  ...
  std::mt19937 gen(rd());
  std::normal_distribution<> d(0.021958, 0.005);
  class Node11{
  	public:
  		Node11(){
			sub_1_11_flag = 0;
		...
		void middlemanCallback8(const std_msgs::String::ConstPtr& msg){
  			if(sub_1_11_flag == 1 && sub_9_11_flag == 1 && sub_10_11_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback9(const std_msgs::String::ConstPtr& msg){
  			if(sub_1_11_flag == 1 && sub_8_11_flag == 1 && sub_10_11_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
