  ...
  std::mt19937 gen(rd());
  std::normal_distribution<> d(0.022889, 0.005);
  class Node13{
  	public:
  		Node13(){
			sub_2_13_flag = 0;
		...
		void middlemanCallback10(const std_msgs::String::ConstPtr& msg){
  			if(sub_2_13_flag == 1 && sub_7_13_flag == 1 && sub_12_13_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback12(const std_msgs::String::ConstPtr& msg){
  			if(sub_2_13_flag == 1 && sub_7_13_flag == 1 && sub_10_13_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
