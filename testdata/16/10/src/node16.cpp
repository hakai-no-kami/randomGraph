#include "ros/ros.h"
  ...
  std::mt19937 gen(rd());
  std::normal_distribution<> d(0.011430, 0.005);
void chatterCallback12(const std_msgs::String::ConstPtr& msg){
  	usleep(d(gen)*1000000);
  	ROS_INFO("I'm node16 and heard from node12: [%s]", msg->data.c_str());
  }
...
int main(int argc, char **argv){
  	...
  	ros::NodeHandle n;
	ros::Subscriber sub_12_16 = n.subscribe("topic_12_16", 1, chatterCallback12);
