  ...
  std::mt19937 gen(rd());
  std::normal_distribution<> d(0.025853, 0.005);
  class Node12{
  	public:
  		Node12(){
			sub_4_12_flag = 0;
		...
		void middlemanCallback5(const std_msgs::String::ConstPtr& msg){
  			if(sub_4_12_flag == 1 && sub_8_12_flag == 1 && sub_11_12_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback8(const std_msgs::String::ConstPtr& msg){
  			if(sub_4_12_flag == 1 && sub_5_12_flag == 1 && sub_11_12_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback11(const std_msgs::String::ConstPtr& msg){
  			if(sub_4_12_flag == 1 && sub_5_12_flag == 1 && sub_8_12_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
