  ...
  std::mt19937 gen(rd());
  std::normal_distribution<> d(0.025909, 0.005);
  class Node11{
  	public:
  		Node11(){
			sub_5_11_flag = 0;
		...
		void middlemanCallback5(const std_msgs::String::ConstPtr& msg){
  			if(sub_6_11_flag == 1 && sub_8_11_flag == 1 && sub_10_11_flag == 1 &&  true){
		...
		void middlemanCallback8(const std_msgs::String::ConstPtr& msg){
  			if(sub_5_11_flag == 1 && sub_6_11_flag == 1 && sub_10_11_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback10(const std_msgs::String::ConstPtr& msg){
  			if(sub_5_11_flag == 1 && sub_6_11_flag == 1 && sub_8_11_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
