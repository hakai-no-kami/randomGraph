  ...
  std::mt19937 gen(rd());
  std::normal_distribution<> d(0.021784, 0.005);
  class Node17{
  	public:
  		Node17(){
			sub_6_17_flag = 0;
  			sub_6_17 = n.subscribe("topic_6_17", 1, &Node17::middlemanCallback6,this);
			sub_7_17_flag = 0;
		...
		void middlemanCallback6(const std_msgs::String::ConstPtr& msg){
  			if(sub_7_17_flag == 1 && sub_13_17_flag == 1 && sub_14_17_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
  				ROS_INFO("I'm node17 last from node6, intercepted: [%s]", msg->data.c_str());
				...
				sub_14_17_flag = 0;
  				...
  				ROS_INFO("I'm node17, from node6 intercepted: [%s]", msg->data.c_str());
  				sub_6_17_flag = 1;
  			}
  		}
		void middlemanCallback7(const std_msgs::String::ConstPtr& msg){
  			if(sub_6_17_flag == 1 && sub_13_17_flag == 1 && sub_14_17_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback13(const std_msgs::String::ConstPtr& msg){
  			if(sub_6_17_flag == 1 && sub_7_17_flag == 1 && sub_14_17_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback14(const std_msgs::String::ConstPtr& msg){
  			if(sub_6_17_flag == 1 && sub_7_17_flag == 1 && sub_13_17_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
