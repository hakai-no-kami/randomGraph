  ...
  std::mt19937 gen(rd());
  std::normal_distribution<> d(0.025382, 0.005);
  class Node5{
  	public:
  		Node5(){
			sub_3_5_flag = 0;
			...
			pub_5_16 = n.advertise<std_msgs::String>("topic_5_16", 1);
			pub_5_15 = n.advertise<std_msgs::String>("topic_5_15", 1);
			pub_5_14 = n.advertise<std_msgs::String>("topic_5_14", 1);
		}
		void middlemanCallback3(const std_msgs::String::ConstPtr& msg){
  			if(sub_4_5_flag == 1 &&  true){
				...
				pub_5_16.publish(msg);
				pub_5_15.publish(msg);
				pub_5_14.publish(msg);
				sub_4_5_flag = 0;
			}
  			else{
	...
	private:
  		ros::NodeHandle n; 
		ros::Publisher pub_5_16;
		ros::Publisher pub_5_15;
		ros::Publisher pub_5_14;
		int sub_3_5_flag;
