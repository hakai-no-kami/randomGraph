  ...
  std::mt19937 gen(rd());
  std::normal_distribution<> d(0.018232, 0.005);
  class Node14{
  	public:
  		Node14(){
			sub_7_14_flag = 0;
		...
		void middlemanCallback7(const std_msgs::String::ConstPtr& msg){
  			if(sub_8_14_flag == 1 && sub_9_14_flag == 1 && sub_10_14_flag == 1 &&  true){
		...
		void middlemanCallback8(const std_msgs::String::ConstPtr& msg){
  			if(sub_7_14_flag == 1 && sub_9_14_flag == 1 && sub_10_14_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback9(const std_msgs::String::ConstPtr& msg){
  			if(sub_7_14_flag == 1 && sub_8_14_flag == 1 && sub_10_14_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback10(const std_msgs::String::ConstPtr& msg){
  			if(sub_7_14_flag == 1 && sub_8_14_flag == 1 && sub_9_14_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
