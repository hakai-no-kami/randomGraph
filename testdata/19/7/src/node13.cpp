  ...
  std::mt19937 gen(rd());
  std::normal_distribution<> d(0.027611, 0.005);
  class Node13{
  	public:
  		Node13(){
			sub_3_13_flag = 0;
		...
		void middlemanCallback3(const std_msgs::String::ConstPtr& msg){
  			if(sub_7_13_flag == 1 && sub_8_13_flag == 1 && sub_11_13_flag == 1 &&  true){
		...
		void middlemanCallback7(const std_msgs::String::ConstPtr& msg){
  			if(sub_3_13_flag == 1 && sub_8_13_flag == 1 && sub_11_13_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback8(const std_msgs::String::ConstPtr& msg){
  			if(sub_3_13_flag == 1 && sub_7_13_flag == 1 && sub_11_13_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback11(const std_msgs::String::ConstPtr& msg){
  			if(sub_3_13_flag == 1 && sub_7_13_flag == 1 && sub_8_13_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
