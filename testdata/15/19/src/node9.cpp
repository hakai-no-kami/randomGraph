  ...
  std::mt19937 gen(rd());
  std::normal_distribution<> d(0.021093, 0.005);
  class Node9{
  	public:
  		Node9(){
			sub_1_9_flag = 0;
		...
		void middlemanCallback2(const std_msgs::String::ConstPtr& msg){
  			if(sub_1_9_flag == 1 && sub_3_9_flag == 1 && sub_5_9_flag == 1 && sub_7_9_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback3(const std_msgs::String::ConstPtr& msg){
  			if(sub_1_9_flag == 1 && sub_2_9_flag == 1 && sub_5_9_flag == 1 && sub_7_9_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback5(const std_msgs::String::ConstPtr& msg){
  			if(sub_1_9_flag == 1 && sub_2_9_flag == 1 && sub_3_9_flag == 1 && sub_7_9_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback7(const std_msgs::String::ConstPtr& msg){
  			if(sub_1_9_flag == 1 && sub_2_9_flag == 1 && sub_3_9_flag == 1 && sub_5_9_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
