  ...
  std::mt19937 gen(rd());
  std::normal_distribution<> d(0.017611, 0.005);
  class Node12{
  	public:
  		Node12(){
			sub_4_12_flag = 0;
		...
		void middlemanCallback6(const std_msgs::String::ConstPtr& msg){
  			if(sub_4_12_flag == 1 && sub_10_12_flag == 1 && sub_11_12_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback10(const std_msgs::String::ConstPtr& msg){
  			if(sub_4_12_flag == 1 && sub_6_12_flag == 1 && sub_11_12_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback11(const std_msgs::String::ConstPtr& msg){
  			if(sub_4_12_flag == 1 && sub_6_12_flag == 1 && sub_10_12_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
