  ...
  std::mt19937 gen(rd());
  std::normal_distribution<> d(0.027442, 0.005);
  class Node7{
  	public:
  		Node7(){
			sub_1_7_flag = 0;
		...
		void middlemanCallback1(const std_msgs::String::ConstPtr& msg){
  			if(sub_4_7_flag == 1 && sub_6_7_flag == 1 &&  true){
		...
		void middlemanCallback4(const std_msgs::String::ConstPtr& msg){
  			if(sub_1_7_flag == 1 && sub_6_7_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback6(const std_msgs::String::ConstPtr& msg){
  			if(sub_1_7_flag == 1 && sub_4_7_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
