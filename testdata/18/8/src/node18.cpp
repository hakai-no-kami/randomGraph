#include "ros/ros.h"
  ...
  std::mt19937 gen(rd());
  std::normal_distribution<> d(0.021658, 0.005);
void chatterCallback2(const std_msgs::String::ConstPtr& msg){
  	usleep(d(gen)*1000000);
  	ROS_INFO("I'm node18 and heard from node2: [%s]", msg->data.c_str());
  }
...
int main(int argc, char **argv){
  	...
  	ros::NodeHandle n;
	ros::Subscriber sub_2_18 = n.subscribe("topic_2_18", 1, chatterCallback2);
