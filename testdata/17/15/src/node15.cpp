  ...
  std::mt19937 gen(rd());
  std::normal_distribution<> d(0.020401, 0.005);
  class Node15{
  	public:
  		Node15(){
			sub_2_15_flag = 0;
		...
		void middlemanCallback9(const std_msgs::String::ConstPtr& msg){
  			if(sub_2_15_flag == 1 && sub_13_15_flag == 1 && sub_14_15_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback13(const std_msgs::String::ConstPtr& msg){
  			if(sub_2_15_flag == 1 && sub_9_15_flag == 1 && sub_14_15_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
