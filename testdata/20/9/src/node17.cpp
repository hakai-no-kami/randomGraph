  ...
  std::mt19937 gen(rd());
  std::normal_distribution<> d(0.017704, 0.005);
  class Node17{
  	public:
  		Node17(){
			sub_7_17_flag = 0;
		...
		void middlemanCallback14(const std_msgs::String::ConstPtr& msg){
  			if(sub_7_17_flag == 1 && sub_15_17_flag == 1 && sub_16_17_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback15(const std_msgs::String::ConstPtr& msg){
  			if(sub_7_17_flag == 1 && sub_14_17_flag == 1 && sub_16_17_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback16(const std_msgs::String::ConstPtr& msg){
  			if(sub_7_17_flag == 1 && sub_14_17_flag == 1 && sub_15_17_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
