  ...
  std::mt19937 gen(rd());
  std::normal_distribution<> d(0.016597, 0.005);
  class Node12{
  	public:
  		Node12(){
			sub_3_12_flag = 0;
		...
		void middlemanCallback7(const std_msgs::String::ConstPtr& msg){
  			if(sub_3_12_flag == 1 && sub_10_12_flag == 1 && sub_11_12_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback10(const std_msgs::String::ConstPtr& msg){
  			if(sub_3_12_flag == 1 && sub_7_12_flag == 1 && sub_11_12_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback11(const std_msgs::String::ConstPtr& msg){
  			if(sub_3_12_flag == 1 && sub_7_12_flag == 1 && sub_10_12_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
