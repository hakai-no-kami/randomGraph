  ...
  std::mt19937 gen(rd());
  std::normal_distribution<> d(0.020757, 0.005);
  class Node10{
  	public:
  		Node10(){
			sub_3_10_flag = 0;
		...
		void middlemanCallback3(const std_msgs::String::ConstPtr& msg){
  			if(sub_4_10_flag == 1 && sub_5_10_flag == 1 && sub_7_10_flag == 1 && sub_8_10_flag == 1 && sub_9_10_flag == 1 &&  true){
		...
		void middlemanCallback4(const std_msgs::String::ConstPtr& msg){
  			if(sub_3_10_flag == 1 && sub_5_10_flag == 1 && sub_7_10_flag == 1 && sub_8_10_flag == 1 && sub_9_10_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback5(const std_msgs::String::ConstPtr& msg){
  			if(sub_3_10_flag == 1 && sub_4_10_flag == 1 && sub_7_10_flag == 1 && sub_8_10_flag == 1 && sub_9_10_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback7(const std_msgs::String::ConstPtr& msg){
  			if(sub_3_10_flag == 1 && sub_4_10_flag == 1 && sub_5_10_flag == 1 && sub_8_10_flag == 1 && sub_9_10_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback8(const std_msgs::String::ConstPtr& msg){
  			if(sub_3_10_flag == 1 && sub_4_10_flag == 1 && sub_5_10_flag == 1 && sub_7_10_flag == 1 && sub_9_10_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback9(const std_msgs::String::ConstPtr& msg){
  			if(sub_3_10_flag == 1 && sub_4_10_flag == 1 && sub_5_10_flag == 1 && sub_7_10_flag == 1 && sub_8_10_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
