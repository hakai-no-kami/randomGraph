  ...
  std::mt19937 gen(rd());
  std::normal_distribution<> d(0.010633, 0.005);
  class Node12{
  	public:
  		Node12(){
			sub_6_12_flag = 0;
		...
		void middlemanCallback6(const std_msgs::String::ConstPtr& msg){
  			if(sub_8_12_flag == 1 && sub_9_12_flag == 1 &&  true){
		...
		void middlemanCallback8(const std_msgs::String::ConstPtr& msg){
  			if(sub_6_12_flag == 1 && sub_9_12_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback9(const std_msgs::String::ConstPtr& msg){
  			if(sub_6_12_flag == 1 && sub_8_12_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
