  ...
  std::mt19937 gen(rd());
  std::normal_distribution<> d(0.022194, 0.005);
  class Node15{
  	public:
  		Node15(){
			sub_6_15_flag = 0;
		...
		void middlemanCallback6(const std_msgs::String::ConstPtr& msg){
  			if(sub_11_15_flag == 1 && sub_13_15_flag == 1 &&  true){
		...
		void middlemanCallback11(const std_msgs::String::ConstPtr& msg){
  			if(sub_6_15_flag == 1 && sub_13_15_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback13(const std_msgs::String::ConstPtr& msg){
  			if(sub_6_15_flag == 1 && sub_11_15_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
