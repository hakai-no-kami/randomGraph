  ...
  std::mt19937 gen(rd());
  std::normal_distribution<> d(0.026975, 0.005);
  class Node6{
  	public:
  		Node6(){
			sub_1_6_flag = 0;
		...
		void middlemanCallback1(const std_msgs::String::ConstPtr& msg){
  			if(sub_3_6_flag == 1 && sub_4_6_flag == 1 && sub_5_6_flag == 1 &&  true){
		...
		void middlemanCallback3(const std_msgs::String::ConstPtr& msg){
  			if(sub_1_6_flag == 1 && sub_4_6_flag == 1 && sub_5_6_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback4(const std_msgs::String::ConstPtr& msg){
  			if(sub_1_6_flag == 1 && sub_3_6_flag == 1 && sub_5_6_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback5(const std_msgs::String::ConstPtr& msg){
  			if(sub_1_6_flag == 1 && sub_3_6_flag == 1 && sub_4_6_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
