  ...
  std::mt19937 gen(rd());
  std::normal_distribution<> d(0.025880, 0.005);
  class Node11{
  	public:
  		Node11(){
			sub_3_11_flag = 0;
		...
		void middlemanCallback3(const std_msgs::String::ConstPtr& msg){
  			if(sub_6_11_flag == 1 && sub_7_11_flag == 1 && sub_8_11_flag == 1 &&  true){
		...
		void middlemanCallback8(const std_msgs::String::ConstPtr& msg){
  			if(sub_3_11_flag == 1 && sub_6_11_flag == 1 && sub_7_11_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
