  ...
  std::mt19937 gen(rd());
  std::normal_distribution<> d(0.025787, 0.005);
  class Node17{
  	public:
  		Node17(){
			sub_2_17_flag = 0;
  			sub_2_17 = n.subscribe("topic_2_17", 1, &Node17::middlemanCallback2,this);
			sub_14_17_flag = 0;
		...
		void middlemanCallback2(const std_msgs::String::ConstPtr& msg){
  			if(sub_14_17_flag == 1 && sub_15_17_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
  				ROS_INFO("I'm node17 last from node2, intercepted: [%s]", msg->data.c_str());
				pub_17_18.publish(msg);
				sub_14_17_flag = 0;
				sub_15_17_flag = 0;
			}
  			else{
  				ROS_INFO("I'm node17, from node2 intercepted: [%s]", msg->data.c_str());
  				sub_2_17_flag = 1;
  			}
  		}
		void middlemanCallback14(const std_msgs::String::ConstPtr& msg){
  			if(sub_2_17_flag == 1 && sub_15_17_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback15(const std_msgs::String::ConstPtr& msg){
  			if(sub_2_17_flag == 1 && sub_14_17_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
