  ...
  std::mt19937 gen(rd());
  std::normal_distribution<> d(0.021030, 0.005);
  class Node5{
  	public:
  		Node5(){
			sub_2_5_flag = 0;
		...
		void middlemanCallback2(const std_msgs::String::ConstPtr& msg){
  			if(sub_3_5_flag == 1 && sub_4_5_flag == 1 &&  true){
		...
		void middlemanCallback3(const std_msgs::String::ConstPtr& msg){
  			if(sub_2_5_flag == 1 && sub_4_5_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback4(const std_msgs::String::ConstPtr& msg){
  			if(sub_2_5_flag == 1 && sub_3_5_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
