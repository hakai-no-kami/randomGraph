#include "ros/ros.h"
  ...
  std::mt19937 gen(rd());
  std::normal_distribution<> d(0.011523, 0.005);
void chatterCallback3(const std_msgs::String::ConstPtr& msg){
  	usleep(d(gen)*1000000);
  	ROS_INFO("I'm node16 and heard from node3: [%s]", msg->data.c_str());
  }
...
int main(int argc, char **argv){
  	...
  	ros::NodeHandle n;
	ros::Subscriber sub_3_16 = n.subscribe("topic_3_16", 1, chatterCallback3);
