  ...
  std::mt19937 gen(rd());
  std::normal_distribution<> d(0.025063, 0.005);
  class Node17{
  	public:
  		Node17(){
			sub_8_17_flag = 0;
  			sub_8_17 = n.subscribe("topic_8_17", 1, &Node17::middlemanCallback8,this);
			sub_13_17_flag = 0;
		...
		void middlemanCallback8(const std_msgs::String::ConstPtr& msg){
  			if(sub_13_17_flag == 1 && sub_14_17_flag == 1 && sub_16_17_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
  				ROS_INFO("I'm node17 last from node8, intercepted: [%s]", msg->data.c_str());
				...
				sub_16_17_flag = 0;
  				...
  				ROS_INFO("I'm node17, from node8 intercepted: [%s]", msg->data.c_str());
  				sub_8_17_flag = 1;
  			}
  		}
		void middlemanCallback13(const std_msgs::String::ConstPtr& msg){
  			if(sub_8_17_flag == 1 && sub_14_17_flag == 1 && sub_16_17_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback14(const std_msgs::String::ConstPtr& msg){
  			if(sub_8_17_flag == 1 && sub_13_17_flag == 1 && sub_16_17_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback16(const std_msgs::String::ConstPtr& msg){
  			if(sub_8_17_flag == 1 && sub_13_17_flag == 1 && sub_14_17_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
