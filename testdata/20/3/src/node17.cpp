  ...
  std::mt19937 gen(rd());
  std::normal_distribution<> d(0.019019, 0.005);
  class Node17{
  	public:
  		Node17(){
			sub_3_17_flag = 0;
  			sub_3_17 = n.subscribe("topic_3_17", 1, &Node17::middlemanCallback3,this);
			sub_13_17_flag = 0;
		...
		void middlemanCallback3(const std_msgs::String::ConstPtr& msg){
  			if(sub_13_17_flag == 1 && sub_14_17_flag == 1 && sub_15_17_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
  				ROS_INFO("I'm node17 last from node3, intercepted: [%s]", msg->data.c_str());
				...
				sub_15_17_flag = 0;
  				...
  				ROS_INFO("I'm node17, from node3 intercepted: [%s]", msg->data.c_str());
  				sub_3_17_flag = 1;
  			}
  		}
		void middlemanCallback13(const std_msgs::String::ConstPtr& msg){
  			if(sub_3_17_flag == 1 && sub_14_17_flag == 1 && sub_15_17_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback14(const std_msgs::String::ConstPtr& msg){
  			if(sub_3_17_flag == 1 && sub_13_17_flag == 1 && sub_15_17_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback15(const std_msgs::String::ConstPtr& msg){
  			if(sub_3_17_flag == 1 && sub_13_17_flag == 1 && sub_14_17_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
