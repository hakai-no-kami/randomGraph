  ...
  std::mt19937 gen(rd());
  std::normal_distribution<> d(0.010293, 0.005);
  class Node15{
  	public:
  		Node15(){
			sub_3_15_flag = 0;
		...
		void middlemanCallback11(const std_msgs::String::ConstPtr& msg){
  			if(sub_3_15_flag == 1 && sub_12_15_flag == 1 && sub_13_15_flag == 1 && sub_14_15_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback12(const std_msgs::String::ConstPtr& msg){
  			if(sub_3_15_flag == 1 && sub_11_15_flag == 1 && sub_13_15_flag == 1 && sub_14_15_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback13(const std_msgs::String::ConstPtr& msg){
  			if(sub_3_15_flag == 1 && sub_11_15_flag == 1 && sub_12_15_flag == 1 && sub_14_15_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback14(const std_msgs::String::ConstPtr& msg){
  			if(sub_3_15_flag == 1 && sub_11_15_flag == 1 && sub_12_15_flag == 1 && sub_13_15_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
