  ...
  std::mt19937 gen(rd());
  std::normal_distribution<> d(0.016062, 0.005);
  class Node19{
  	public:
  		Node19(){
			sub_13_19_flag = 0;
		...
		void middlemanCallback13(const std_msgs::String::ConstPtr& msg){
  			if(sub_15_19_flag == 1 && sub_18_19_flag == 1 &&  true){
		...
		void middlemanCallback15(const std_msgs::String::ConstPtr& msg){
  			if(sub_13_19_flag == 1 && sub_18_19_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
		...
		void middlemanCallback18(const std_msgs::String::ConstPtr& msg){
  			if(sub_13_19_flag == 1 && sub_15_19_flag == 1 &&  true){
  				usleep(d(gen)*1000000);
